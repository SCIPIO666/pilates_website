...
const Instructor: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div ref={imageWrapRef} className="order-1 md:order-2 relative flex items-center justify-center py-6">
        <svg className="absolute -top-6 right-4 md:right-8 w-36 h-36 md:w-48 md:h-48 text-clay/50 pointer-events-none transform rotate-12" viewBox="0 0 200 200" fill="currentColor">
        ...
        <svg className="absolute -bottom-8 left-4 md:left-10 w-44 h-44 md:w-56 md:h-56 text-bone pointer-events-none transform -rotate-45" viewBox="0 0 200 200" fill="currentColor">
        ...
        <svg className="absolute top-1/3 -left-4 md:-left-8 w-16 h-16 md:w-24 md:h-24 text-olive/30 pointer-events-none" viewBox="0 0 200 200" fill="currentColor">
        ...
        <div
          ...
          className="relative z-10 w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-bone shadow-lg mx-auto"
        >
          <Image
            src={instructorImg}
            alt="Maya - Pilates Instructor"
            fill
